...
class SiteSettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            'footer_copyright' => '© 2026 JR-Ecom. All Rights Reserved. Designed for Excellence.',
            'footer_description' => 'JR-Ecom is a premier multi-category e-commerce platform offering top brands, fast shipping, and 24/7 dedicated customer care.',
